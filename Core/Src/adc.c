...
/**
  ...
  * @retval Откалиброванное значение в милливольтах (канал 1) или миллиамперах (канал 2)
...
int32_t ADC_Get_Scaled_Value(void)
{
    ...
    else
    {
        ...
        // Предполагаем: 20mA -> 3.3V, I_mA = V_measured * 20 / 3300
        physical_value = (voltage_mv * 20UL) / 3300UL;
