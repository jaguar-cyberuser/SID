...
/**
  ******************************************************************************
  * @file    utilities.c
  * @brief   Implementation of utilities module
  ******************************************************************************
  * Модуль вспомогательных функций: CRC32, CRC16, проверочные суммы, точные задержки.
...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
// Lookup-таблица для быстрого расчета CRC32
...
/**
  * @brief Расчет CRC32 с использованием lookup-таблицы
  * @param data: указатель на данные для расчета
...
/**
  * @brief Расчет CRC16 Modbus - ЕДИНСТВЕННАЯ РЕАЛИЗАЦИЯ ДЛЯ ВСЕГО ПРОЕКТА
  * @param data: указатель на данные для расчета
  * @param length: длина данных в байтах
  * @retval Рассчитанное значение CRC16 Modbus
...
/**
  * @brief Точная задержка в микросекундах на основе циклов
